...
const services = [
  {
    title: "Tabela ve Totem Üretimi",
    icon: <BuildingStorefrontIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "Reklam Pazarlama Fikirleri",
    icon: <MegaphoneIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "Tasarım Hizmetleri",
    icon: <PaintBrushIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "UI-UX Tasarım",
    icon: <CursorArrowRaysIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "IOS / ANDROID Uygulama Geliştirme",
    icon: <DevicePhoneMobileIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "Programlama",
    icon: <CodeBracketSquareIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "e-Mail Hizmetleri",
    icon: <EnvelopeIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
  {
    title: "e-Ticaret",
    icon: <ShoppingCartIcon className="h-10 w-10 text-gray-700 mb-3" />,
  },
];
...
export default function Home() {
  return (
    <Container>
      ...
      <ScrollReveal>
        <SectionTitle
          title=" İşiniz Benzersizdir Çünkü Biz Üretiyoruz"
        >
          <p>
            Bizimle çalışan her marka ve ürün için özen gösterir, araştırır, analiz eder ve müşteriye özel çözümler sunarız.
          </p>
          <div className="flex justify-center my-5">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="px-8 py-4 text-lg font-medium text-center text-white bg-gray-950 rounded-md ">
              Çalışmalarımız
            </a>
          </div>
        </SectionTitle>
      ...
      <ScrollReveal delay={0.1}><Benefits data={benefitOne} /></ScrollReveal>
      <ScrollReveal delay={0.2}><Benefits imgPos="right" data={benefitTwo} /></ScrollReveal>

      <ScrollReveal delay={0.3}>
        <SectionTitle
          title="Neler Yapıyoruz?"
        >
          Mağaza tabelası, totem, reklam tanıtım, basılı material, digital alanlarda tasarım hizmeti, mobil uygulama ve web tabanlı yazılımları ROINMAX markası adı altında topladık. Kurumsal yapı üzerine kurulu hizmet faaliyetlerimiz ile sizleri doğru zamanda doğru hedefe ulaştırıyoruz.
        </SectionTitle>
      </ScrollReveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 my-10">
          {services.map((service, idx) => (
            <ScrollReveal key={idx} delay={0.05 * idx}>
              <div
                className="bg-white rounded-lg shadow p-6 text-center font-semibold text-gray-900 transition transform hover:-translate-y-2 hover:shadow-xl hover:bg-gray-50 cursor-pointer group"
              >
                <div className="flex justify-center">
                  {service.icon}
                </div>
                <div className="mt-2 group-hover:text-blue-700 transition-colors duration-200">
                  {service.title}
                </div>
              </div>
            </ScrollReveal>
      ...
      {/* Referanslarımız - Marquee */}
      {(() => {
        const logos = [
          <AmazonLogo key="amazon" />,
          <MicrosoftLogo key="microsoft" />,
          <NetflixLogo key="netflix" />,
          <SonyLogo key="sony" />,
          <VerizonLogo key="verizon" />
        ];
        return (
          <div className="relative w-screen left-1/2 right-1/2 -translate-x-1/2 overflow-hidden py-6 bg-gray-50 dark:bg-gray-800">
            {/* Sol gölge */}
            <div className="pointer-events-none absolute top-0 left-0 h-full w-16 z-10" style={{background: 'linear-gradient(to right, rgba(249,250,251,1) 60%, rgba(249,250,251,0) 100%)'}} />
            {/* Sağ gölge */}
            <div className="pointer-events-none absolute top-0 right-0 h-full w-16 z-10" style={{background: 'linear-gradient(to left, rgba(249,250,251,1) 60%, rgba(249,250,251,0) 100%)'}} />
            <div className="flex items-center space-x-8 animate-marquee whitespace-nowrap min-w-max">
      ...
      <ScrollReveal delay={0.7}><Testimonials /></ScrollReveal>
      <ScrollReveal delay={0.8}>
        <SectionTitle title="Roinmax Reklam Gücü
">
